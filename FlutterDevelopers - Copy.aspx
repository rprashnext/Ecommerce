<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlutterDevelopers.aspx.cs" Inherits="CRM_SOFTWARE.FlutterDevelopers" %>
    ...
    <br />
      <br />
        <section  id="Header-cont">
                    <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid;width:60%"><strong><u style="text-underline-position:below">Looking for Flutter App Development Company ?</u></strong></h1>
...
<button type="button" class="btn-block btn-info" style="width:60%;color:white"><a href="portfolio.aspx" class="view_more_btn fd_btn_view"><strong>Our Portfolio!</strong><span class="fa fa-arrow-right"></span></a></button>
        <br />
                    <br />
                      <br />
                     <section class="col-lg-12" style="width:100%;margin-left:30%;margin-top:-21%">
                        ...
                        <div class="form_con">
                            ...
                            <div class="col-md-12 col-xs-12">
                                    ...
                                    <button onclick="processEmailForm('HIRE_MOBILE_APP_DEVELOPER',this);_gaq.push(['_trackEvent','iOS - Top Form','Clicked','Submitbtn'])" class="button_submit btn-primary" name="submit" type="button"> Submit
                                    </button>
        ...
        <section class="col-lg-12" style="margin-top:1%">
             <div class="container-fluid">
                       <ol class="breadcrumb remove-val">
                           ...
                           <li><a href="FlutterDevelopers.aspx">FlutterDevelopers</a></li>
                       </ol>
                      </div>
        </section>
        <section class="col-lg-12">
            <div class="row">
                       <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">Best-in-class Flutter App Development Solution</u></strong></h1>
              <img src="images/top-section-flutter-application-development.png" class="w3-animate-fading" style="height:400px;margin-left:65%;animation-direction:alternate;animation-delay:10s" />
                             <div class="col-lg-7" style="margin-top:-21%">
 <p class="w3-animate-top" style="text-align:left;opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black"><strong>Soft Suave is the leading Flutter app development company that offers clients with robust and cost-effective next-generation solutions. Developers in Soft Suave use Flutter to make your mobile app versatile, which facilitates in saving time and effort while development. Clients testify that Flutter apps from Soft Suave are innovative and feature-rich compared to the competitors.</strong></p>
 <p class="w3-animate-top" style="text-align:left;opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black"><strong>This is the standard Soft Suave has set in the Flutter app development industry. Our skilled developers are experienced in designing & develop smart, flexible, and reliable solutions for your cross-platform development projects. When compared to other hybrid frameworks, Flutter gives you the performance that is exceptionally close to a native app.</strong></p>
  <p class="w3-animate-top" style="text-align:left;opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black"><strong>The number of widgets and tools in flutter gives Soft Suave various options to customize your solution and bring your app development dream to life.</strong></p>
                             </div>
                     </div>
        </section>
        <section class="col-lg-12">
            <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">Our Flutter Development Services</u></strong></h1>
             <div class="w3-container">
      <div class="w3-card-4 w3-hover-blue" style="width:30%">
      <figure><center><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/flutter/cross-plat-flutter.png" id="hover-effect-icon" alt="Cross Platform app development company by soft suave" title="Cross Platform app development company by soft suave" itemprop="contentUrl"class="w3-animate-fading" style="height:300px;width:400px;animation-direction:alternate-reverse;animation-delay:10s" /></center></figure>
              <div class="w3-container w3-center">
                <p class="w3-code" style="text-align:center"><strong>Cross Platform app development</strong></p>
              </div>
           </div>
           <div class="w3-card-4 w3-hover-blue" style="width:30%;margin-left:65%;margin-top:-21.6%">
  <figure><center><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/flutter/data.svg" id="hover-effect-icon" alt="Hire Dedicated Flutter Developers from Soft Suave" title="Hire Dedicated Flutter Developers from Soft Suave" itemprop="contentUrl"class="w3-animate-fading" style="height:300px;width:400px;animation-direction:alternate-reverse;animation-delay:10s"/></center></figure>
                          <div class="w3-container w3-center">
                        <p class="w3-code" style="text-align:center"><strong>Hire Dedicated Flutter Developers</strong></p>
                   </div>
              </div>
             <hr class="solid"  style="border-top: 15px solid #bbb;" />
            <div class="w3-card-4 w3-hover-blue" style="width:30%">
<figure><center><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/flutter/icon-6.png" alt="Industry Specific app development solutions" title="Industry Specific app development solutions" class="w3-animate-fading" style="height:300px;width:400px;animation-direction:alternate;animation-delay:10s"/></center></figure>
                          <div class="w3-container w3-center">
                        <p class="w3-code" style="text-align:center"><strong>Industry Specific Application Development</strong></p>
                   </div>
            </div>
    <div class="w3-card-4 w3-hover-blue" style="width:30%;margin-left:65%;margin-top:-21.6%">
<figure><center><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/flutter/flutter-checklist.svg"  alt="End to end app development support" title="End to end app development support" class="w3-animate-fading" style="height:300px;width:400px;animation-direction:alternate;animation-delay:10s" /></center></figure>
                          <div class="w3-container w3-center">
                        <p class="w3-code" style="text-align:center"><strong>End to end app development support</strong></p>
                   </div>
            </div>
        </div>
            </section>
        <section class="col-lg-12">
            <img src="images/flutter_dribbble_2x.png" class="w3-animate-fading" style="height:350px;width:550px;margin-left:5%;margin-top:5%;animation-direction:alternate;animation-delay:10s"/>
                         <div class="col-md-offset-5" style="margin-top:-24%">
                            <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">Cross-Platform App Development</u></strong></h1>
                         <p class="text-justify" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black">
                                  <strong>Flutter is known as the best framework to support Cross-Platform App Development. Soft Suave uses this advantage to eliminate the need for separate iOS and Android developers, thus providing the client with cost-effective cross-platform applications. Our developers provide feature enhancement, create intuitive UI and maintain the apps easily as most of the flutter apps are developed using single code base. The hands-on experience of our developers extends to the year when Flutter was introduced which gives us a fair amount of advantage over the competitors.</strong>
                              </p>
                          <p class="text-justify" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black">
                                   <strong>Being the top Cross-platform app development company in India and the USA, Soft Suave caters the exact need of the clients and empowers your business with solutions that fit the best.</strong>
                               </p>
                        </div>
        </section>
        <section class="col-lg-12 w3-animate-fading w3-animate-left" style="background-color:whitesmoke">
             <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid;width:50%"><strong><u style="text-underline-position:below">Hire Dedicated Flutter Developers</u></strong></h1>
                <p class="text-justify" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black;width:50%">
                                <strong>Soft Suave is the top flutter app development company in India and the USA that helps you to hire dedicated and quality Flutter developers at an affordable cost. Clients approaching us with Flutter app development projects repeatedly shows the experience and commitment of our Flutter developers. Our developers are ready to overlap time zones and provide round the clock support to create success for the client. Our developers distinctly understand the client’s USP needs and work on customizing the solution according to the business requirement.</strong>
                            </p>
                 <p class="text-justify" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black;width:50%">
                                  <strong>Most importantly, our developers implement high-quality flutter solutions on cross-platforms in record time to set the benchmark for the industry.</strong>
                              </p>
                       <img src="images/mobile-app-development-flutter.png" class="w3-animate-fading" style="height:350px;margin-left:65%;margin-top:-35%;animation-direction:alternate;animation-delay:10s"/>
        </section>
        <section class="col-lg-12">
<img src="images/imgbanner-fluter.png" class="w3-animate-fading"  style="height:350px;width:550px;margin-left:5%;margin-top:5%;animation-direction:alternate;animation-delay:10s"/>
                        <div class="col-lg-offset-6" style="margin-top:-24%">
                            <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">Industry-Specific Solutions</u></strong></h1>
                       <p class="text-justify" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black">
                                  <strong>Soft Suave provides Flutter solution to clients by adding customization according to the type of industry the client is into. We have worked across various industry verticals since the onset of Flutter framework and helped businesses in varied domains. Our developers’ experience and technical knowledge in Flutter helps them to understand the industry and then develop app solutions that perfectly blend with the Industry. Industry-specific Flutter Solutions from our developers not only stand out from the competition but also shatters the market with the smooth functionalities and future-ready features.</strong>
                              </p>
                         <p class="text-justify" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black">
                                   <strong>Thus, Soft Suave is named as the best in crafting industry-specific solutions just the way clients want.</strong>
                               </p>
                        </div>
        </section>
        <section class="col-lg-12 w3-animate-fading w3-animate-left" style="background-color:whitesmoke">
            <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid;width:50%"><strong><u style="text-underline-position:below">End-to-End Support & Maintenance</u></strong></h1>
              <p class="text-justify" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black;width:50%">
                                <strong>Soft Suave being the top flutter development company in India and the USA, is known to provide the best end-to-end support and maintenance for flutter applications deployed for their clients. Our specialists in Flutter make customer satisfaction a priority and provide quick support and continuous maintenance. The developers also follow a well-defined process when they provide support for the flutter applications. Soft Suave’s elite support and maintenance process set the benchmark for all the other flutter development companies.</strong>
                            </p>
                <p class="text-justify" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black;width:50%">
                                  <strong>ESoft Suave believes in the success of the client’ business be it flutter development or any process involving the support and maintenance of flutter application.</strong>
                              </p>
<img src="images/flutter-development.png" class="w3-animate-fading" style="height:350px;margin-left:65%;margin-top:-35%;animation-direction:alternate;animation-delay:10s" />
        </section>
        <section class="col-lg-12">
             <h1  class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below"><span>NEED EXPERT</span> <img src="images/Flutter.png" style="height:30px"/> DEVELOPERS?</u></strong></h1>
               <p class="w3-cursive" style="font-family:'Times New Roman';font-size:xx-large;font-weight:bolder">
                   <strong>
                       Soft Suave helps you with options to choose from our team of highly skilled Flutter developers to work remotely on your critical projects.
                   </strong>
               </p>
        </section>
    <section class="col-lg-12">
...
<div id="id01" class="modal">
  ...
  <form class="modal-content" action="/action_page.php">
     <center>
    <div id="form_con">
        <h2 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid">Hire Flutter Developers @ $15 / Hr</h2>
        <hr />
         ...
         <br />
            <br />
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><i class="glyphicon glyphicon-map-marker"> <u style="text-underline-position:below">ADDRESS:-</u></i></strong></h1>
            ...
            <div class="col-lg-12">
                <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><i class="glyphicon glyphicon-envelope"> <u style="text-underline-position:below">EMAIL-ID:-</u></i></strong></h1>
            ...
            <div class="col-lg-12">
                <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><i class="glyphicon glyphicon-phone">           <u style="text-underline-position:below">CONTACT-NUMBER:-</u></i></strong></h1>
