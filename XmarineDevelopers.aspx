<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XmarineDevelopers.aspx.cs" Inherits="CRM_SOFTWARE.XmarineDevelopers" %>
...
<br />
   ...
   <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid;width:60%"><strong><u style="text-underline-position:below">Looking for Xamarin App Development in Your Budget ?</u></strong></h1>
                      <p class="description" style="text-align:left;opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black;width:60%"><strong>Soft Suave is the Top Flutter App Development Company in India and the USA that Develops Flutter applications that are extremely close to the native performance.</strong></p>
                 </section>
...
<button onclick="processEmailForm('HIRE_MOBILE_APP_DEVELOPER',this);_gaq.push(['_trackEvent','iOS - Top Form','Clicked','Submitbtn'])" class="button_submit btn-primary" name="submit" type="button"> Submit</button>
   ...
   <li><a href="Home.aspx"><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/web/home.svg" height="20px" width="20px" style="margin-top: -5px;" /></a></li>
                           ...
                           <li><a href="XmarineDevelopers.aspx">XmarineDevelopers</a></li>
                       </ol>
                      </div>
        </section>
        <section class="col-lg-12">
             <div class="row">
                       <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">Business-Driven Xamarin App Development Solutions</u></strong></h1>
              <img src="images/xamarin-first-img.png" style="height:400px;margin-left:67%;animation-direction:alternate-reverse;animation-delay:10s" class="w3-animate-fading"/>
                             <div class="col-lg-8" style="margin-top:-21%">
                                 <p class="w3-animate-top" style="text-align:left;opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black"><strong>Soft Suave is the leading Xamarin mobile application development company offering the best cross-platform Xamarin mobile app development services using C#, Visual Studio, Xamarin forms and frameworks. Our dedicated mobile app developers put in place Xamarin solutions to empower your objectives to receive higher returns.</strong></p>
                                 <p class="w3-animate-top" style="text-align:left;opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black"><strong>During every stage of design and development process, our Xamarin developers optimize your apps for high value and superior usability for your end-customers. The application developed using Xamarin platform use hardware acceleration, which directly drives the performance like a native application.</strong></p>
                                 <p class="w3-animate-top" style="text-align:left;opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black"><strong>The Xamarin apps from Soft Suave are all Future Ready to stay ahead in the competition as Xamarin allows the re-use of code across all platforms as well as the integration of libraries written natively for each platform.</strong></p>
                             </div>
                     </div>
        </section>
        <section class="col-lg-12">
             <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">Our Strength in Xamarin</u></strong></h1>
            <div class="w3-container">
      <div class="w3-card-4 w3-hover-blue" style="width:30%">
   <figure><center><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/consulting.svg" id="hover-effect-icon" alt="Xamarin consultant by soft suave" title="Xamarin consultant by soft suave" itemprop="contentUrl" class="w3-animate-fading" style="height:300px;width:400px;animation-direction:alternate-reverse;animation-delay:10s" /></center></figure>
              <div class="w3-container w3-center">
                <p class="w3-code" style="text-align:center"><strong>Xamarin Consulting</strong></p>
              </div>
           </div>
           <div class="w3-card-4 w3-hover-blue" style="width:30%;margin-left:65%;margin-top:-21.5%">
  <figure><center><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/hired.svg" id="hover-effect-icon" alt="Xamarin developers from soft suave" title="Xamarin developers from soft suave" itemprop="contentUrl" class="w3-animate-fading" style="height:300px;width:400px;animation-direction:alternate-reverse;animation-delay:10s"/></center></figure>
                          <div class="w3-container w3-center">
                        <p class="w3-code" style="text-align:center"><strong>Hire Xamarin Developers</strong></p>
                   </div>
              </div>
            <hr class="solid"  style="border-top: 15px solid #bbb;" />
            <div class="w3-card-4 w3-hover-blue" style="width:30%">
<figure><center><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/mobile-app.svg" id="hover-effect-icon" alt="Xamarin app development by soft suave" title="Xamarin app development by soft suave" itemprop="contentUrl" class="w3-animate-fading" style="height:300px;width:400px;animation-direction:alternate;animation-delay:10s" /></center></figure>
                          <div class="w3-container w3-center">
                        <p class="w3-code" style="text-align:center"><strong>Xamarin App Development</strong></p>
                   </div>
            </div>
    <div class="w3-card-4 w3-hover-blue" style="width:30%;margin-left:65%;margin-top:-21.5%">
<figure><center><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/chat.svg" id="hover-effect-icon" alt="Cross platform application development company Soft Suave" title="Cross platform application development company Soft Suave" class="w3-animate-fading" style="height:300px;width:400px;animation-direction:alternate;animation-delay:10s" /></center></figure>
                          <div class="w3-container w3-center">
                        <p class="w3-code" style="text-align:center"><strong>Cross-platform Application</strong></p>
                   </div>
            </div>
    </div>
</section>
        <section class="col-lg-12">
             <img src="images/xamarin-consulting.png" class="w3-animate-fading"   style="height:350px;width:550px;margin-left:5%;margin-top:5%;animation-direction:alternate;animation-delay:10s"/>
                        <div class="col-md-offset-5" style="margin-top:-24%">
 <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">Xamarin Consulting</u></strong></h1>
                   <p class="text-justify" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black">
                     <strong>Soft Suave offers Xamarin application specialists who provide consulting services that helps you transform your business strategies into high-performing Xamarin applications Soft Suave,known as the best Xamarin app development company in India, provide clients with the right advice to accelerate their mobile app development using Xamarin. Our Xamarin specialists always take an extra step to fix bugs in your application and streamline the development process by choosing over Xamarin Forms and Xamarin Native according to your necessity.</strong>
                              </p>
                   <p class="text-justify" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black">
                        <strong>Our Xamarin consulting clients include large enterprises, small & medium-sized business, as well as high growth start-ups.</strong>
                               </p>
                        </div>
        </section>
        <section class="col-lg-12 w3-animate-fading w3-animate-right" style="background-color:whitesmoke">
  <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid;width:50%"><strong><u style="text-underline-position:below">Hire Xamarin Developers</u></strong></h1>
                  <p class="text-justify" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black;width:50%">
                                <strong>Developers at Soft Suave are well-versed in the Xamarin platform and are very efficient when they are hired to work for clients. If you want a consistent look and feel across the platform or prefer a native look and feel, our developers will get your application done and running in no time. The amount of the latest tools and technologies our developers use to build the client’s application has made Soft Suave the leading and trustworthy mobile app development company in the USA and India.</strong>
                            </p>
                  <p class="text-justify" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black;width:50%">
                                  <strong>Our Xamarin developers are flexible to your requirements and will overlap your time zone and build custom application solutions that take your business to the next level.</strong>
                              </p>
 <img src="images/xamarin-HIRE.png" class="w3-animate-fading" style="height:350px;margin-left:65%;margin-top:-35%;animation-direction:alternate;animation-delay:10s" />
     </section>
       <section class="col-lg-12">
           <img src="images/app-develop.png" class="w3-animate-fading"  style="height:350px;width:550px;margin-left:5%;margin-top:5%;animation-direction:alternate;animation-delay:10s""/>
                        <div class="col-md-offset-5" style="margin-top:-24%">
                            <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">Xamarin App Development</u></strong></h1>
                            <p class="text-justify" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black">
                                  <strong>Soft Suave provides Xamarin app development 10X faster at a less expensive cost comparing to our competitors. Being the best Xamarin app development company, we don’t compromise on quality when it comes to the development of applications. Our Xamarin developers are experts in developing applications with an interactive & highly responsive UI for iOS, Android, and Windows platforms. Our team, with the amount of experience with Xamarin can efficiently work round the clock to deliver high performing and easy to maintain apps, with the fastest turnaround time.</strong>
                              </p>
                            <p class="text-justify" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black">
                                   <strong>Thus, Xamarin apps developed by Soft Suave is assured to push your competition out of the market and helps you in topping the industry market easily.</strong>
                               </p>
                        </div>
       </section>
          <section class="col-lg-12 w3-animate-fading w3-animate-left" style="background-color:whitesmoke">
 <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid;width:50%"><strong><u style="text-underline-position:below">Cross-platform Application</u></strong></h1>
                  <p class="text-justify" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black;width:50%">
                                <strong>At Soft Suave, we build highly-customizable and scalable cross-platform applications with the help of C# to give you access to all the platform-specific functionalities and to make it look & feel native. Using Xamarin to develop Cross-platform application not only reduces money, time and resource but also provides the best reach for your application in the market.</strong>
                            </p>
                  <p class="text-justify" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black;width:50%">
                                  <strong>Our developers’ well-versed experience and exposure in customized cross-platform app development using Xamarin technology make Soft Suave the best and trusted Xamarin Cross-platform App Development Company in India and the USA.</strong>
                              </p>
                       <img src="images/Cross-Platform%20(1).png" class="w3-animate-fading" style="height:350px;margin-left:65%;margin-top:-35%;animation-direction:alternate;animation-delay:10s""/>
        </section>
        <section class="col-lg-12">
            <h1  class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below"><span>NEED EXPERT</span> <img src="images/Xmarine.png" style="height:30px"/> DEVELOPERS?</u></strong></h1>
               <p class="text-left" style="font-family:'Times New Roman';font-size:xx-large;font-weight:bolder">
                   <strong>
                       Soft Suave gives you access to our certified and experienced Xamarin app developers at an affordable cost to carry out your app development projects swiftly.
                   </strong>
               </p>
        </section>
        <section class="col-lg-12">
...
<div id="id01" class="modal">
  ...
  <form class="modal-content" action="/action_page.php">
     <center>
    <div id="form_con">
        <h2 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid">Hire Xmarine Developers @ $15 / Hr</h2>
        <hr />
...
<script>
    ...
    <section class="col-lg-12">
        <h1  class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">Xamarin Development Technologies We Use</u></strong></h1>
         <p class="w3-cursive" style="font-family:'Times New Roman';font-size:xx-large;font-weight:bolder">
             <strong>
                 Xamarin developers from Soft Suave are skilful and well versed in the following technologies
             </strong>
         </p>
        <section class="padb20 padb50">
            <div class="container">
                <div class="row">
                    <div class="spb_tabs tabs-type-standard spb_content_element col-sm-12" data-interval="0" style="width:95%;tab-size:6;table-layout:fixed;margin-left:30%">
                            ...
                            <ul class="nav nav-tabs center-tabs">
                             <li class="active"><a href="#frontend" data-toggle="tab" aria-expanded="true"><span>Front End</span></a></li>
                               <li class=""><a href="#operatingsystems" data-toggle="tab" aria-expanded="true"><span>Operating Systems</span></a>
                                ...
                                <li class=""><a href="#xamarintools" data-toggle="tab" aria-expanded="true"><span>Xamarin Tools</span></a>
                                </li>
                                        ...
                                        <div class="spb_content_element col-sm-12 spb_text_column">
                                            <div class="spb-asset-content" style="margin-top: 0px;margin-bottom: 0px;">
                                                <ul class="list-inline list-group list-group-item" style="padding: unset;">
                                                    <li>
                                                        <figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/XMLID_1_2.png" title="Hire Xamarin developers from soft suave" alt="Hire Xamarin developers from soft suave" style="height:50px;background-color:aqua"/></figure>
                              <p class="w3-code  text-center" style="background-color:antiquewhite;font-size:x-large">Xamarin</p>
                                                    </li>
                                                    <li>
                                                        <figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/C-Sharp-01.png" title="c# development by soft suave" alt="c# development by soft suave" style="height:50px"/></figure>
                                       <p class="w3-code  text-center"  style="background-color:antiquewhite;font-size:x-large">C#</p>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <section class="row ">
                                        <div class="spb_content_element col-sm-12 spb_text_column">
                                            <div class="spb-asset-content" style="margin-top: 0px;margin-bottom: 0px;">
                                                ...
                                                <ul class="list-inline list-group list-group-item" style="padding: unset;">
                                                    <li>
<figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/iOS.png" alt="iOS development service by soft suave" title="iOS development service by soft suave" style="height:50px"/></figure>
                                <p class="w3-code  text-center"  style="background-color:antiquewhite;font-size:x-large">iOS</p>
                                                    </li>
                                                    <li>
 <figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/android.png" alt="Android development service by soft suave" title="Android development service by soft suave" style="height:50px"/></figure>
                                 <p class="w3-code  text-center"  style="background-color:antiquewhite;font-size:x-large">Android</p>
                                                    </li>
                                                    <li>
  <figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/XMLID_1_5.png" alt="MacOS" title="MacOS" style="height:50px"/></figure>
                       <p class="w3-code  text-center"  style="background-color:antiquewhite;font-size:x-large">macOS</p>                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    </section>
                                    ...
                                    <section class="row ">
                                        <div class="spb_content_element col-sm-12 spb_text_column">
                                            <div class="spb-asset-content" style="margin-top: 0px;margin-bottom: 0px;">
                                                ...
                                                <ul class="list-inline list-group list-group-item" style="padding: unset;">
                                                    <li>
                                                        <figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/xamarin-studio.png" alt="Xamarin Studio" title="Xamarin Studio" style="height:50px;background-color:aqua"/></figure>
                                    <p class="w3-code  text-center"  style="background-color:antiquewhite;font-size:x-large">Xamarin Studio</p>
                                                    </li>
                                                    <li>
                                                        <figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/xamarin-form.png" alt="Xamarin Forms" title="Xamarin Forms" style="height:50px"/></figure>
                                      <p class="w3-code  text-center"  style="background-color:antiquewhite;font-size:x-large">Xamarin.forms</p>
                                                    </li>
                                                    <li>
                                                        <figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/xamarin_cloud.png" alt="Xamarin Cloud" title="Xamarin Cloud" style="height:50px"/></figure>
                                 <p class="w3-code  text-center"  style="background-color:antiquewhite;font-size:x-large">Xamarin Test Cloud</p>
                                                    </li>
                                                    <li>
                                                        <figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/XMLID_1.png" alt="Visual Studio" title="Visual Studio" style="height:50px"/></figure>
                                      <p class="w3-code  text-center" style="background-color:antiquewhite;font-size:x-large">Visual Studio</p>
                                                    </li>
                                                    <li>
                                                        <figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/XMLID_13.png" alt="Mono" title="Mono" style="height:50px" /></figure>
                                      <p class="w3-code  text-center"  style="background-color:antiquewhite;font-size:x-large">Mono</p>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <section class="row ">
                                        <div class="spb_content_element col-sm-12 spb_text_column">
                                            <div class="spb-asset-content" style="margin-top: 0px;margin-bottom: 0px;">
                                                <ul class="list-inline list-group list-group-item" style="padding: unset;">
                                                    <li>
                                                        <figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/aws.png" alt="Aws" style="height:50px"/></figure>
                                        <p class="w3-code  text-center"  style="background-color:antiquewhite;font-size:x-large">Aws</p>
                                                    </li>
                                                    <li>
                                                        <figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/azure.png" alt="Azure" style="height:50px"/></figure>
                                        <p class="w3-code  text-center"  style="background-color:antiquewhite;font-size:x-large">Azure</p>
                                                    </li>
                                                    <li>
                                                        <figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/googleCloud.png" alt="Google Cloud" style="height:50px"/></figure>
                                      <p class="w3-code  text-center"  style="background-color:antiquewhite;font-size:x-large">Google Cloud</p>
                                                    </li>
                                                    <li>
                                                        <figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/xamarin-app-center.png" alt="App Center for CI/CD" style="height:50px"/></figure>
                               <p class="w3-code  text-center"  style="background-color:antiquewhite;font-size:x-large">App Center for CI/CD</p>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <section class="row ">
                                        <div class="spb_content_element col-sm-12 spb_text_column">
                                            <div class="spb-asset-content" style="margin-top: 0px;margin-bottom: 0px;">
                                                <ul class="list-inline list-group list-group-item" style="padding: unset;">
                                                    <li>
<figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/firebase-1-logo.png" alt="Firebase" style="height:50px"/></figure>
                                <p class="w3-code  text-center"  style="background-color:antiquewhite;font-size:x-large">Firebase</p>
                                                    </li>
                                                    <li>
<figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/xamarin/Google-Analytics-01.png" alt="Google Analytics" style="height:50px"/></figure>
                                <p class="w3-code  text-center"  style="background-color:antiquewhite;font-size:x-large">Google Analytics</p>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
