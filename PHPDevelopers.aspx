<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PHPDevelopers.aspx.cs" Inherits="CRM_SOFTWARE.PHPDevelopers" %>
    ...
    <br />
      <br />
        <section  id="Header-cont">
                    <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid;width:60%"><strong><u style="text-underline-position:below">Build Applications with Dynamic PHP Development Company</u></strong></h1>
 <p class="description" style="text-align:left;opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black;width:60%"><strong>Soft Soft Suave is the top PHP development company that provides high-quality solutions with best client satisfaction.</strong></p>
                 </section>
        <button type="button" class="btn-block btn-primary btn-info" style="width:60%;font-size:x-large"><a href="portfolio.aspx"><strong>Our Portfolio!</strong> <span class="fa fa-arrow-right"></span></a></button>
       <br />
         <br />
          <br />
           <section class="col-lg-12" style="width:106%;margin-left:30%;margin-top:-18.4%">
...
<button onclick="processEmailForm('HIRE_MOBILE_APP_DEVELOPER',this);_gaq.push(['_trackEvent','iOS - Top Form','Clicked','Submitbtn'])" class="button_submit btn-primary" name="submit" type="button"> Submit</button>
   ...
   <li><a href="Home.aspx"><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/web/home.svg" height="20px" width="20px" style="margin-top: -5px;" /></a></li>
                           ...
                           <li><a href="PHPDevelopers.aspx">PHPDevelopers</a></li>
                </ol>
           </div>
    </section>
    <section class="col-lg-12">
        <div class="row">
  <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">Soft Suave’s Business-Driven PHP Development Solutions</u></strong></h1>
      <img src="images/PHP-Development-Business-Driven-Solution.png" class="w3-animate-fading" style="height:390px;margin-left:70%;margin-top:3%;animation-direction:alternate;animation-delay:10s"/>
                             <div class="col-lg-8" style="margin-top:-24%">
                                 <p class="w3-animate-top" style="text-align:left;opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black"><strong>We claim ourselves to be the top PHP web application development company in terms of client satisfaction, uncompromising development strategy, and high-quality solutions.</strong></p>
                                 <p class="w3-animate-top" style="text-align:left;opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black"><strong>Being India's leading PHP web application development company and design services with years of expertise, we ensure creating high quality, flexible, and interactive websites for our clients with no delay in delivery.We explore the latest technologies and provide far beyond what is expected of us and that is partly the secret behind our success.</strong></p>
                                 <p class="w3-animate-top" style="text-align:left;opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black"><strong>Apart from this, we have developers and designers who are hardworking and have expertise in pioneering technologies to come up with brilliant web solutions for our clients. Our PHP developers give their 100% to every project that they work. This has brought in many appreciations from our clients across the globe.</strong></p>
                             </div>
                </div>
    </section>
    <section class="col-lg-12">
<h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">Our PHP Application Development Services</u></strong></h1>
<p class="w3-animate-top" style="text-align:left;opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black">
    <strong>
We have been developing web applications in PHP for the last 8+ years and have added our expertise on various PHP application development frameworks and PHP services. We have also been recognized as the best custom PHP application development company by clients globally and mainly across USA, Europe, Canada and Australia. Soft Suave provides an array of services on PHP web application development with the support of our skilled PHP developers. The services we offer are listed below.
    </strong>
</p>
 <div class="w3-container">
      <div class="w3-card-4 w3-hover-blue" style="width:30%">
      <figure><center><img src="https://www.softsuave.com/assets/new-formate/PHP/php-1.webp" alt="Custom PHP Development Soft Suave" class="w3-animate-fading" style="height:300px;width:400px;animation-direction:alternate-reverse;animation-delay:10s" /></center></figure>
              <div class="w3-container w3-center">
                <p class="w3-code" style="text-align:center"><strong>Custom PHP Development</strong></p>
              </div>
           </div>
           <div class="w3-card-4 w3-hover-blue" style="width:30%;margin-left:65%;margin-top:-21.6%">
  <figure><center><img src="https://www.softsuave.com/assets/new-formate/PHP/php-2.webp" alt="Open Source PHP Development Company Soft Suave" class="w3-animate-fading" style="height:300px;width:400px;animation-direction:alternate-reverse;animation-delay:10s"/></center></figure>
                          <div class="w3-container w3-center">
                        <p class="w3-code" style="text-align:center"><strong>Open Source PHP Development</strong></p>
                   </div>
              </div>
             <hr class="solid"  style="border-top: 15px solid #bbb;" />
            <div class="w3-card-4 w3-hover-blue" style="width:30%">
<figure><center><img src="https://www.softsuave.com/assets/new-formate/PHP/php-3.webp" alt="PHP eCommerce Development Company Soft Suave" class="w3-animate-fading" style="height:300px;width:400px;animation-direction:alternate;animation-delay:10s"/></center></figure>
                          <div class="w3-container w3-center">
                        <p class="w3-code" style="text-align:center"><strong>PHP eCommerce Development</strong></p>
                   </div>
            </div>
    <div class="w3-card-4 w3-hover-blue" style="width:30%;margin-left:65%;margin-top:-21.6%">
<figure><center><img src="https://www.softsuave.com/assets/new-formate/PHP/php-4.webp" alt="Responsive Web Design Company Soft Suave" class="w3-animate-fading" style="height:300px;width:400px;animation-direction:alternate;animation-delay:10s"/></center></figure>
                          <div class="w3-container w3-center">
                        <p class="w3-code" style="text-align:center"><strong>Responsive Web Design</strong></p>
                   </div>
            </div>
        </div>
    </section>
    <section class="col-lg-12">
  <img src="images/PHP-Custom-Development.jpeg" alt="Custom PHP Development Company in India &amp; USA - Soft Suave" class="w3-animate-fading" style="height:550px;width:750px;margin-left:5%;margin-top:20%;animation-direction:alternate;animation-delay:10s"/>

        <div class="col-lg-offset-6" style="margin-top:-32.5%">
  <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">PHP Custom Application Development</u></strong></h1>
       <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black">
                                  <strong>Custom applications are generally used by businesses to collaborate with external organizations to facilitate communication and coordination between them. We develop customized websites & web applications leveraging advanced technologies like Yii framework, CakePHP, CodeIgniter, etc. to cater top class websites to businesses to meet different requirements & meet specific targets.</strong>
                           </p>
                      <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black">
                                  <strong>Delivering a high-performance PHP web application is not easy! We accomplish fully interactive websites with robust functionality using modern tools and best coding practices. Our approach of tweaking open source platforms for developing extremely scalable web applications result in completing challenging projects in a short period.</strong>
                               </p>
        </div>
    </section>
    <section class="col-lg-12 w3-animate-right w3-animate-fading" style="background-color:whitesmoke">
        <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid;width:50%"><strong><u style="text-underline-position:below">Open Source CMS Development</u></strong></h1>
   <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black;width:50%">
   <strong>Out of all, Content Management System (CMS) development is considered as the most crucial part of web development. Especially in business websites, content plays a vital role. Combining business domain expertise with the best industry standard’s knowledge, we create robust and scalable CMS solutions offering easy content management.</strong>
 </p>
  <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black;width:50%">
  <strong>Our PHP development experts develop user-friendly CMS solutions having the flexibility to quickly adapt and update all your data as and when needed. We develop a completely new solution from scratch or modify an already available open source CMS solution as per your requirements.</strong>
 </p>
 <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black;width:50%">
  <strong>While performing all the quality checks before delivering the product to you, we ensure that our tailor-made CMS solution is compatible with any third-party plugins and can be seamlessly integrated with any platform like eCommerce or more.</strong>
 </p>
  <img src="images/Open%20Source%20CMS%20Development.jpeg" alt="Custom PHP Development Company in India &amp; USA - Soft Suave" class="w3-animate-fading" style="height:550px;width:950px;margin-left:55%;margin-top:-37%;animation-direction:alternate;animation-delay:10s"/>
    </section>
    <section class="col-lg-12">
        <img src="images/PHP-Ecommerce-Development.jpeg" class="w3-animate-fading" style="height:450px;width:650px;margin-left:10%;margin-top:10%;animation-direction:alternate;animation-delay:10s"/>
        <div class="col-lg-offset-6" style="margin-top:-29.5%">
  <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">PHP ECommerce Development</u></strong></h1>
       <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black">
                                  <strong>Giving our customers amazing shopping experience with fully featured shopping carts and a safe payment processing system is our PHP development team’s motto. With the help of our developers, we create profitable B2B or B2C eCommerce applications to meet your business objectives.</strong>
                           </p>
                      <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black">
                                  <strong>We deliver eCommerce solutions with outstanding features like one-click management, multiple promotions, 3-step checkout, interactive admin panel, user-friendly shopping cart, and easy and secure payment gateway integration. Our online shopping portal will be engaging, and we have the expertise to create a customized shopping cart from scratch as well.</strong>
                               </p>
        </div>
    </section>
    <section class="col-lg-12 w3-animate-right w3-animate-fading" style="background-color:whitesmoke">
<h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid;width:50%"><strong><u style="text-underline-position:below">Responsive Web Designing</u></strong></h1>
  <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black;width:50%">
   <strong>Our products are designed for the four corners of screens, not just for any specific device's screen dimensions making them future-proof. We design websites with performance in mind so that you have a great experience no matter what device you use.</strong>
 </p>
 <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black;width:50%">
  <strong>We design web applications that work great with a variety of browsers including IE8 +, iOS, Android 2+, Windows Phone 7, Firefox, Safari, and Chrome that solve problems for real people. These features make Soft Suave the best custom PHP application development company in India.</strong>
 </p>
  <img src="https://www.softsuave.com/assets/new-formate/PHP/php-responsive.webp" alt="Responsive Web Design Service by Soft Suave" class="w3-animate-fading" style="height:350px;width:950px;margin-left:49%;margin-top:-24%;animation-direction:alternate;animation-delay:10s"/>
    </section>
    <section class="col-lg-12">
      <h1  class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below"><span>NEED EXPERT</span><img src="images/PhP.png" style="height:30px;margin-top:-3px"/> DEVELOPERS?</u></strong></h1>
               <p class="w3-cursive" style="text-align:left;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder">
                   <strong>
        Soft Suave gives you access to our experienced PHP app developers at an affordable cost to complete your development projects swiftly.
                   </strong>
               </p>
 <button type="button" class="btn-block btn-success" style="font-size:x-large"><a href="Hire-PHP-Developers.aspx">Hire PHP Developer!</a> <span class="fa fa-arrow-right"></span></button>
    </section>
    <section class="col-lg-12">
          <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">PHP Development Technologies We Use</u></strong></h1>
        <p class="w3-cursive" style="text-align:left;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder">
           <strong>.NET developers from Soft Suave are proficient and sophisticated in the following technologies</strong>
        </p>
        <div class="spb_tabs tabs-type-standard spb_content_element col-sm-12" data-interval="0" style="margin-left:30%;width:60%">
                <div class="spb-asset-content spb_wrapper spb_tabs_wrapper">
                    <ol class="nav nav-tabs center-tabs">
                        <li class=""><a href="#frontend" data-toggle="tab"><span>Front End</span></a></li>
                        <li class=""><a href="#operatingsystems" data-toggle="tab" aria-expanded="true"><span>Frameworks</span></a>
                        </li>
                        <li class=""><a href="#xamarintools" data-toggle="tab" aria-expanded="true"><span> Web Services</span></a>
                        </li>
                        <li class="active"><a href="#others" data-toggle="tab" aria-expanded="true"><span>Database</span></a></li>
                    </ol>
                            ...
                            <section class="row ">
                                <div class="spb_content_element col-sm-12 spb_text_column">
                                    <div class="spb-asset-content" style="margin-top: 0px;margin-bottom: 0px;">
                                        <ol class="list-inline list-group list-group-item" style="padding: unset;">
                                            <li>
        <figure><img src="images/HTML5.png"  alt="HTMl" title="HTMl" style="height:100px"/></figure>
              <p class="w3-code text-center" style="background-color:antiquewhite;font-size:x-large"><strong><b>HTML</b></strong></p>
                                            </li>
                                            <li>
        <figure><img src="images/Sass_Logo.svg.png" alt="SASS" title="SASS" style="height:100px"/></figure>
               <p class="w3-code text-center" style="background-color:antiquewhite;font-size:x-large"><strong><b>Sass</b></strong></p>
                                            </li>
                                            <li>
 <figure><img  src="https://softsuave-assets.s3.amazonaws.com/images/2020/php/JavaScript_logo.png" alt="Javascript" title="Javascript" style="height:100px"/></figure>
                <p class="w3-code text-center" style="background-color:antiquewhite;font-size:x-large"><strong><b>Javascript</b></strong></p>
                                            </li>
                                        </ol>
                                    </div>
                                </div>
                            ...
                            <section class="row ">
                                <div class="spb_content_element col-sm-12 spb_text_column">
                                    <div class="spb-asset-content" style="margin-top: 0px;margin-bottom: 0px;">
                                        <ol class="list-inline list-group list-group-item" style="padding: unset;">
                                            <li >
 <figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/php/laravel-icon.png" alt="Laravel" title="Laravel" style="height:100px" /></figure>
                 <p class="w3-code text-center" style="background-color:antiquewhite;font-size:x-large"><strong><b>Laravel</b></strong></p>
                                            </li>
                                            <li>
          <figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/php/cake-php.png" alt="CakePHP" title="CakePHP" style="height:100px" /></figure>
                 <p class="w3-code text-center" style="background-color:antiquewhite;font-size:x-large"><strong><b>CakePHP</b></strong></p>
                                            </li>
                                            <li>
<figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/php/codeigniter-icon.png" alt="CodeIgnitor" title="CodeIgnitor" style="height:100px" /></figure>
               <p class="w3-code text-center" style="background-color:antiquewhite;font-size:x-large"><strong><b>Codegniter</b></strong></p>
                                            </li>
                                            <li>
<figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/php/zend-icon.png" alt="Zend" title="Zend" style="height:100px" /></figure>
                <p class="w3-code text-center" style="background-color:antiquewhite;font-size:x-large"><strong><b>Zend</b></strong></p>
                                            </li>
                                            <li>
<figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/php/yii-icon.png" alt="Yii" title="Yii" style="height:100px" /></figure>
                <p class="w3-code text-center" style="background-color:antiquewhite;font-size:x-large"><strong><b>Yii</b></strong></p>
                                            </li>
                                        </ol>
                                    </div>
                                </div>
                            ...
                            <section class="row ">
                                <div class="spb_content_element col-sm-12 spb_text_column">
                                    <div class="spb-asset-content" style="margin-top: 0px;margin-bottom: 0px;">
                                        <ol class="list-inline list-group list-group-item" style="padding: unset;">
                                            <li>
   <figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/php/soap.png" alt="Soap" title="Soap" style="height:100px" /></figure>
                  <p class="w3-code text-center" style="background-color:antiquewhite;font-size:x-large"><strong><b>SOAP</b></strong></p>
                                            </li>
                                            <li>
       <figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/php/xml.png" alt="XML" title="XML" style="height:100px"/></figure>
                  <p class="w3-code text-center" style="background-color:antiquewhite;font-size:x-large"><strong><b>XML</b></strong></p>
                                            </li>
                                            <li>
     <figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/php/json.png" alt="JSON" title="JSON" style="height:100px"/></figure>
                  <p class="w3-code text-center" style="background-color:antiquewhite;font-size:x-large"><strong><b>JSON</b></strong></p>
                                            </li>
                                            <li>
   <figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/php/ajax.png" alt="Ajax" title="Ajax" style="height:100px" /></figure>
                  <p class="w3-code text-center" style="background-color:antiquewhite;font-size:x-large"><strong><b>AJAX</b></strong></p>
                                            </li>
                                        </ol>
                                    </div>
                                </div>
                            ...
                            <section class="row ">
                                <div class="spb_content_element col-sm-12 spb_text_column">
                                    <div class="spb-asset-content" style="margin-top: 0px;margin-bottom: 0px;">
                                        <ol class="list-inline list-group list-group-item" style="padding: unset;">
                                            <li>
<figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/php/mysql5x.png" alt="MySQL" title="MySQL" style="height:100px"/></figure>
            <p class="w3-code text-center" style="background-color:antiquewhite;font-size:x-large"><strong><b>MySQL</b></strong></p>
                                            </li>
                                            <li>
<figure><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/php/MongoDB_Logo_FullColorBlack_RGB-4td3yuxzjs.png" alt="MongoDB" title="MongoDB" style="height:100px" /></figure>
           <p class="w3-code text-center" style="background-color:antiquewhite;font-size:x-large"><strong><b>MongoDB</b></strong></p>
                                            </li>
                                        </ol>
                                    </div>
                                </div>
