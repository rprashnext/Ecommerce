<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NodeJsDevelopers.aspx.cs" Inherits="CRM_SOFTWARE.NodeJsDevelopers" %>
    ...
    <br />
      <br />
        <section  id="Header-cont">
                    <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid;width:60%"><strong><u style="text-underline-position:below">India’s Best Node.js Web Development Company</u></strong></h1>
 <p class="description" style="text-align:left;opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black;width:60%"><strong>Soft Suave is the best NodeJS development company to fulfill your development needs with high responsive apps.</strong></p>
                 </section>
...
<button onclick="processEmailForm('HIRE_MOBILE_APP_DEVELOPER',this);_gaq.push(['_trackEvent','iOS - Top Form','Clicked','Submitbtn'])" class="button_submit btn-primary" name="submit" type="button"> Submit</button>
   ...
   <li><a href="Home.aspx"><img src="https://softsuave-assets.s3.amazonaws.com/images/2020/web/home.svg" height="20px" width="20px" style="margin-top: -5px;" /></a></li>
                           ...
                           <li><a href="NodeJsDevelopers.aspx">NodeJsDevelopers</a></li>
                </ol>
           </div>
    </section>
    <section class="col-lg-12">
        <div class="row">
  <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">Soft Suave into NodeJS Web Development</u></strong></h1>
      <img src="images/Node.js-Development.jpeg" class="w3-animate-fading" style="height:390px;margin-left:70%;margin-top:3%;animation-direction:alternate;animation-duration:10s"/>
          <div class="col-lg-8" style="margin-top:-24%">
        <p class="w3-animate-top" style="text-align:left;opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black"><strong>NodeJS is an open-source, cross-platform that is extensively used for developing stable, faster server tools and network applications. Node.js is a JavaScript runtime environment that enables developers to interpret the pre-requisites in a more approachable way. Basic modules in NodeJS are written in JavaScript, thereby allowing the developers to write new modules effectively.</strong></p>
       <p class="w3-animate-top" style="text-align:left;opacity: 8;font-family:'Times New Roman';font-size:xx-large;font:bolder;color:black"><strong>At Soft Suave, various types of applications are being developed in NodeJS, considering it as one of the significant platforms. Being the leading NodeJS development company in the USA and India, we leverage the technology to provide excellent application development services, including mobile application, web application, network applications, and real-time applications. If you are in search of a perfect application provider based on NodeJS, then partner with us and gain the best NodeJS development services at an affordable cost.</strong></p>
                             </div>
                </div>
    </section>
    <section class="col-lg-12">
        <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">Our NodeJS Development Services</u></strong></h1>
        <div class="w3-container">
      <div class="w3-card-4 w3-hover-blue" style="width:30%">
    <figure><center><img src="https://www.softsuave.com/assets/new-formate/nodejs/icon-1.webp" alt="ECommerce Solution Using NodeJS" class="w3-animate-fading" style="height:300px;width:400px;animation-direction:alternate-reverse;animation-delay:10s"/></center></figure>
              <div class="w3-container w3-center">
                <p class="w3-code" style="text-align:center"><strong>ECommerce Solution Using NodeJS</strong></p>
              </div>
           </div>
           <div class="w3-card-4 w3-hover-blue" style="width:30%;margin-left:32%;margin-top:-21.5%">
    <figure><center><img src="https://www.softsuave.com/assets/new-formate/nodejs/icon-2.webp" alt="Social Networking &amp; Collaboration Applications Development"  class="w3-animate-fading" style="height:300px;width:400px;animation-direction:alternate-reverse;animation-delay:10s"/></center></figure>
                          <div class="w3-container w3-center">
                        <p class="w3-code" style="text-align:center"><strong>Social Networking Applications & Colabrations</strong></p>
                   </div>
              </div>
            <div class="w3-card-4 w3-hover-blue" style="width:30%;margin-left:65%;margin-top:-21.6%">
<figure><center><img src="https://www.softsuave.com/assets/new-formate/nodejs/icon-3.webp" alt="Online Business Application Development" class="w3-animate-fading" style="height:300px;width:400px;animation-direction:alternate-reverse;animation-delay:10s"/></center></figure>
                          <div class="w3-container w3-center">
                        <p class="w3-code" style="text-align:center"><strong>Online Business Applications</strong></p>
                   </div>
            </div>
         <hr class="solid"  style="border-top: 15px solid #bbb;" />
    <div class="w3-card-4 w3-hover-blue" style="width:30%">
<figure><center><img src="images/CMS-Development-PHP.png" class="w3-animate-fading" alt="CMS For Data Management by Soft Suave" title="CMS For Data Management by Soft Suave" itemprop="contentUrl"  style="height:300px;width:400px;animation-direction:alternate-reverse;animation-delay:10s"/></center></figure>
                          <div class="w3-container w3-center">
                        <p class="w3-code" style="text-align:center"><strong>CMS For Data Management</strong></p>
                   </div>
            </div>
            <div class="w3-card-4 w3-hover-blue" style="width:30%;margin-left:32%;margin-top:-21.5%">
    <figure><center><img src="https://www.softsuave.com/assets/new-formate/nodejs/icon-5.webp" alt="Advanced NodeJS Programming Company" class="w3-animate-fading" style="height:300px;width:400px;animation-direction:alternate-reverse;animation-delay:10s"/></center></figure>
                          <div class="w3-container w3-center">
                        <p class="w3-code" style="text-align:center"><strong>Advanced Node.js Programing</strong></p>
                   </div>
              </div>
            <div class="w3-card-4 w3-hover-blue" style="width:30%;margin-left:65%;margin-top:-21.6%">
<figure><center><img src="https://www.softsuave.com/assets/new-formate/nodejs/icon-4.webp" alt="Custom NodeJS Programming Company" class="w3-animate-fading" style="height:300px;width:400px;animation-direction:alternate-reverse;animation-delay:10s"/></center></figure>
                          <div class="w3-container w3-center">
                        <p class="w3-code" style="text-align:center"><strong>Custom Node.js Programing</strong></p>
                   </div>
            </div>
        </div>
    </section>
    <section class="col-lg-12">
     <img src="https://www.softsuave.com/assets/new-formate/nodejs/ecom.webp" class="w3-animate-fading" alt="E-commerce Development Solutions Soft Suave" style="height:350px;width:650px;margin-left:5%;margin-top:10%;animation-direction:alternate;animation-duration:10s"/>
        <div class="col-md-offset-5" style="margin-top:-24.5%">
  <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">E-commerce Development Solutions</u></strong></h1>
       <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black"><strong>Our NodeJS developers have vast knowledge and experience in eCommerce mobile app development. They hold the extraordinary potential to create secure, responsive and reliable NodeJS eCommerce applications,thus giving a good start to your business.</strong>
                           </p>
 <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black"><strong>The development of clean coding practices of Soft Suave ensures that your applications and projects are made without errors. This guaranteed approach confirms your system is running without much maintenance issues. We remain committed to eCommerce and shopping cart development, helping you optimize the power of online commerce.</strong>
             </p>
        </div>
    </section>
    <section class="col-lg-12 w3-animate-right w3-animate-fading" style="background-color:whitesmoke">
<h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid;width:50%"><strong><u style="text-underline-position:below">Social Networking & Collaboration Applications</u></strong></h1>
   <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black;width:50%">
   <strong>As the top NodeJS development company in India and the USA, we develop secure and competent web-based solutions for social media platforms and CRM using our expert NodeJS developers.</strong>
 </p>
  <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black;width:50%">
  <strong>We are a skilled corporate social networking application solution provider, designing modern and tailored solutions with a lot of attractive features that suit your business needs. We also develop corporate platform that takes the involvement level of your employees, customers, staff members, and partners to a higher level.</strong>
 </p>
  <img src="https://www.softsuave.com/assets/new-formate/nodejs/socio.webp" class="w3-animate-fading" alt="Social Networking &amp; Collaboration Applications Development Soft Suave" style="height:350px;width:750px;margin-left:55%;margin-top:-24%;animation-direction:alternate;animation-duration:10s"/>
    </section>
    <section class="col-lg-12">
      <img src="https://www.softsuave.com/assets/new-formate/nodejs/online.webp" class="w3-animate-fading" alt="Online Business Application Development Soft Suave" style="height:350px;width:650px;margin-left:10%;margin-top:5%;animation-direction:alternate;animation-duration:10s"/>
        <div class="col-lg-offset-6" style="margin-top:-24.5%">
  <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">Online Business Application</u></strong></h1>
       <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black"><strong>Online business web applications are the backbone of eCommerce and online multi-vendor marketplaces; thus, we take the responsibility of developing the best for your business. Today, many successful businesses have powerful websites to complement walk-in sales.</strong>
         </p>
         <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black"><strong>Over the years, we have helped many businesses to develop their own online business application and steer their growth using NodeJS. In our work culture, we encourage team members to offer suggestions, share, solve problems and work better thus bringing better output.</strong>
               </p>
           </div>
    </section>
    <section class="col-lg-12 w3-animate-right w3-animate-fading" style="background-color:whitesmoke">
        <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid;width:50%"><strong><u style="text-underline-position:below">CMS for Data Management</u></strong></h1>
   <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black;width:50%">
   <strong>We provideweb applications that are relevant and updated. Leveraging NodeJS, we provide robust CMS or Back-End system in their application utilizing best data management that can be stress-free. We relate to your idea and provide you the best solution that fits your business needs.</strong>
 </p>
  <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black;width:50%">
 ...
 <img src="https://www.softsuave.com/assets/new-formate/nodejs/cms.webp" class="w3-animate-fading" alt="CMS for Data Management Company Soft Suave" style="height:350px;width:750px;margin-left:55%;margin-top:-24%;animation-direction:alternate;animation-duration:10s"/>
    </section>
    <section class="col-lg-12">
   <img src="https://www.softsuave.com/assets/new-formate/nodejs/custom.webp" class="w3-animate-fading" alt="Advanced NodeJS Programming Company Soft Suave" style="height:350px;width:650px;margin-left:10%;margin-top:5%;animation-direction:alternate;animation-duration:10s"/>
        <div class="col-lg-offset-6" style="margin-top:-24.5%">
  <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">Advanced NodeJS Programming</u></strong></h1>
       <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black"><strong>We enhance the features and functionalities of the application and make it more efficient for your business by using advanced NodeJS programming structure. Achieve your business goals faster with NodeJS.</strong>
         </p>
         <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black"><strong>NodeJS is preferred by companies like Yahoo, Twitter, LinkedIn, eBay, etc. because of its cross-platform compatibility and cloud scalability. The large roster of projects, companies, and applications are still counting for NodeJS. Being one of the best NodeJS experts, we provide the best NodeJS application development services and craft real-time web-based applications to drive your business smoothly.</strong>
               </p>
           </div>
    </section>
    <section class="col-lg-12 w3-animate-right w3-animate-fading" style="background-color:whitesmoke">
        <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid;width:50%"><strong><u style="text-underline-position:below">Custom NodeJS Programming</u></strong></h1>
   <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black;width:50%">
   <strong>Every business needs custom-made solutions, and we develop bespoke solutions to meet our client needs. To meet such client requirements, we use custom NodeJS programming and provide matchless solutions for them.</strong>
 </p>
  <p class="text-left" style="opacity: 8;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder;color:black;width:50%">
  <strong>Our qualified and passionate developers have a rigorous understanding and knowledge of the framework. This always enables two-way communication between the servers and the clients. Initially, we understand your business needs and act accordingly, suiting your requirements, and offering affordable services. If you are outsourcing custom NodeJS app development, we’re sure to develop a fruitful association with you that lasts longer!</strong>
 </p>
 <img src="https://www.softsuave.com/assets/new-formate/nodejs/node.webp" class="w3-animate-fading" alt="Custom NodeJS Programming Company Soft Suave" style="height:450px;width:750px;margin-left:55%;margin-top:-30%;animation-direction:alternate;animation-duration:10s"/>
    </section>
    <section class="col-lg-12">
        <h1  class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below"><span>NEED EXPERT</span><img src="images/download.png" style="height:30px;margin-top:-3px"/>DEVELOPERS?</u></strong></h1>
               <p class="w3-cursive" style="text-align:left;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder">
                   <strong>
       Soft Suave gives you access to our experienced NodeJS app developers at an affordable cost to complete your development projects swiftly.
                   </strong>
               </p>
 <button type="button" class="btn-block btn-success" style="font-size:x-large"><a href="Hire-NodeJs-Developers.aspx">Hire Node.Js Developers!</a><span class="fa fa-arrow-right"></span></button>
    </section>
    <section class="col-lg-12">
      <h1 class="text-center w3-animate-left w3-hover-gray" style="background-color:royalblue;font-size:xx-large;font-weight:bolder;font-family:'Times New Roman';color:white;border:thick solid"><strong><u style="text-underline-position:below">NodeJS Development Technologies We Use</u></strong></h1>
        <p class="w3-cursive" style="text-align:left;font-family:'Times New Roman';font-size:xx-large;font-weight:bolder">
           <strong>NodeJS developers from Soft Suave are proficient and sophisticated in the following technologies</strong>
        </p>
        <div class="spb_tabs tabs-type-standard spb_content_element col-sm-12" data-interval="0" style="tab-size:6;margin-left:15%;width:85%">
                <div class="spb-asset-content spb_wrapper spb_tabs_wrapper">
                    <ul class="nav nav-tabs center-tabs">
                        <li class="active"><a href="#frontend" data-toggle="tab"><span>Frameworks</span></a></li>
                        <li class=""><a href="#operatingsystems" data-toggle="tab"><span>Template Engine</span></a></li>
                        <li class=""><a href="#xamarintools" data-toggle="tab"><span>Database</span></a></li>
                    </ul>
                                ...
                                <div class="spb_content_element col-sm-12 spb_text_column">
                                    <div class="spb-asset-content" style="margin-top: 0px;margin-bottom: 0px;">
                                        <ul class="list-inline list-group list-group-item list-unstyled" style="padding: unset;">
                                            <li>
 <figure><img loading="lazy" src="https://softsuave-assets.s3.amazonaws.com/images/2020/node/Expressjs.png"  alt="Expressjs" title="Expressjs" style="height:100px"/></figure>
                         <p class="w3-code text-center" style="font-size:x-large;background-color:antiquewhite"><strong>ExpressJS</strong></p>
                                            </li>
                                            <li>
                     <figure><img src="images/LoopBack.jpeg" style="height:100px"/></figure>
                         <p class="w3-code text-center" style="font-size:x-large;background-color:antiquewhite"><strong>Loopback</strong></p>
                                            </li>
                                            <li>
                        <figure><img src="images/Hapi.png" style="height:100px"/></figure>
                           <p class="w3-code text-center" style="font-size:x-large;background-color:antiquewhite"><strong>Hapi</strong></p>
                                            </li>
                                            <li>
                  <figure><img src="images/FeatherJs.png" alt="FeatherJS" title="FeatherJS" style="height:100px"/></figure>
                         <p class="w3-code text-center" style="font-size:x-large;background-color:antiquewhite"><strong>Featherjs</strong></p>
                                            </li>
                                            <li>
<figure><img loading="lazy" src="https://softsuave-assets.s3.amazonaws.com/images/2020/node/salis.png"  alt="SalisJS" title="SalisJS" style="height:100px"/></figure>
                       <p class="w3-code text-center" style="font-size:x-large;background-color:antiquewhite"><strong>SalisJS</strong></p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <section class="row ">
                                <div class="spb_content_element col-sm-12 spb_text_column">
                                    <div class="spb-asset-content" style="margin-top: 0px;margin-bottom: 0px;">
                                        ...
                                        <ul class="list-inline list-group list-group-item list-unstyled" style="padding: unset;">
                                            <li>
    <figure><img loading="lazy" src="https://softsuave-assets.s3.amazonaws.com/images/2020/node/dust.png" alt="DustJS" title="DustJS" height="100px"></figure>
                   <p class="w3-code text-center" style="font-size:x-large;background-color:antiquewhite"><strong>DustJS</strong></p>
                                            </li>
                                            <li>
<figure><img loading="lazy" src="https://softsuave-assets.s3.amazonaws.com/images/2020/node/handlebars-js.png" alt="mustache" title="mustache" height="100px"></figure>
                    <p class="w3-code text-center" style="font-size:x-large;background-color:antiquewhite"><strong>Mustache</strong></p>
                                            </li>
                                            <li>
                     <figure><img src="images/PUGJs.png" style="height:100px"/></figure>
                   <p class="w3-code text-center" style="font-size:x-large;background-color:antiquewhite"><strong>Pug</strong></p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <section class="row ">
                                <div class="spb_content_element col-sm-12 spb_text_column">
                                    <div class="spb-asset-content" style="margin-top: 0px;margin-bottom: 0px;">
                                        <ul  class="list-inline list-group list-group-item list-unstyled" style="padding: unset;">
                                            <li>
<figure><img loading="lazy" src="https://softsuave-assets.s3.amazonaws.com/images/2020/node/MySQL.svg.png" alt="MySql" title="MySql" style="height:100px"/></figure>
                               <p class="w3-code text-center" style="font-size:x-large;background-color:wheat"><strong>My SQL</strong></p>
                                            </li>
                                            <li>
                                            <figure><img src="images/PostgresSQL.png" style="height:100px"/></figure>
                           <p class="w3-code text-center" style="font-size:x-large;background-color:wheat"><strong>Postgres SQL</strong></p>
                                            </li>
                                            <li>
   <figure><img loading="lazy" src="https://softsuave-assets.s3.amazonaws.com/images/2020/node/firebase-1-logo.png" alt="Firebase" title="Firebase" style="height:100px" /></figure>
                      <p class="w3-code text-center" style="font-size:x-large;background-color:wheat"><strong>Firebase</strong></p>
                                            </li>
                                            <li>
 <figure><img loading="lazy" src="https://softsuave-assets.s3.amazonaws.com/images/2020/node/MongoDB_Logo_FullColorBlack_RGB-4td3yuxzjs.png" alt="MongoDB" title="MongoDB" style="height:100px" /></figure>
                   <p class="w3-code text-center" style="font-size:x-large;background-color:wheat"><strong>MongoDB</strong></p>
                                            </li>
                                            <li>
           <figure><img src="images/download%20(2).png" style="height:100px"/></figure>
                      <p class="w3-code text-center" style="font-size:x-large;background-color:wheat"><strong>CockroachDB</strong></p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
